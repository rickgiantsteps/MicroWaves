...
public class EDO24keyboard extends AppCompatActivity implements View.OnTouchListener {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            tones[tone-1] = soundgenerator.generateTone2(edo24[tone-1], volume, wave, this, tones, tone-1);
            tones[tone-1].play();
            lastfreq = BigDecimal.valueOf(edo24[tone - 1]).setScale(4, BigDecimal.ROUND_FLOOR) + " Hz";
