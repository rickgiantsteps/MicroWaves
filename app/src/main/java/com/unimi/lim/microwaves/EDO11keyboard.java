...
public class EDO11keyboard extends AppCompatActivity implements View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edo11 = pitchcalculator.calculateEqualScale(a4, ottava, edonumber);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            tones[tone-1] = soundgenerator.generateTone(edo11[tone-1], volume, wave, this);
            tones[tone-1].play();
            lastfreq = BigDecimal.valueOf(edo11[tone - 1]).setScale(4, RoundingMode.FLOOR) + " Hz";
